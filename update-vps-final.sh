...
restart_services() {
    ...
    pm2 start server.js --name "kaolack-backend" -- --port=$BACKEND_PORT
...
show_status() {
    ...
    echo "  • Affichage des personnalités créées"
    echo "  • Bouton d'approbation des posts"
    echo "  • Suppression améliorée des posts"
    echo "  • Gestion JWT corrigée"
    echo ""
}
