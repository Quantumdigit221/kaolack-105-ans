...
- [ ] Frontend accessible (https://kaolackcommune.sn)
- [ ] API accessible (https://api.kaolackcommune.sn/api)
...
✅ Health:       https://api.kaolackcommune.sn/api/health (returns "ok")
...
# 5. C'est bon! Accéder à https://kaolackcommune.sn
```
