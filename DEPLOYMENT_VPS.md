...
# Domaine API
curl -k https://api.kaolack.sn

# Vérifier les certificats SSL
openssl s_client -connect kaolack.sn:443
openssl s_client -connect api.kaolack.sn:443
```
...
openssl s_client -connect kaolack.sn:443 -servername kaolack.sn 2>/dev/null | \
...
openssl x509 -in /etc/letsencrypt/live/kaolack.sn/cert.pem -noout -dates
...
2. **Testez la connectivité**: `curl -v https://api.kaolack.sn/api/health`
...
- Frontend: https://kaolack.sn
- API: https://api.kaolack.sn/api
- Documentation API: https://api.kaolack.sn/api/docs
